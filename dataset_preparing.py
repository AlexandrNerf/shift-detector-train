...
def split_data(dataset_path, split_coeff):
    ...
    train_files, val_files = train_test_split(txt_files, test_size=split_coeff, random_state=42)
...
if __name__ == "__main__":
    ...
    parser.add_argument('train_val_split', type=float, default=0.2, help='Размер валидационной выборки')
    parser.add_argument('--dataset_path', type=str, default='dataset', help='Путь к директории с датасетом')
